...
export const singularityMilestones = {
  ...
  autoCondense: {
    ...
    effect: (completions) => AtomMilestone.am3.isReached ? 1 : [Infinity, 1.3, 1.22, 1.15, 1.1, 1.06, 1.03, 1.01, 1][completions],
  ...
  darkDimensionAutobuyers: {
    ...
    effect: (completions) => AtomMilestone.am3.isReached ? 4 : completions,
  ...
  darkAutobuyerSpeed: {
    ...
    effect: (completions) => AtomMilestone.am3.isReached ? 0 : [30, 20, 15, 10, 5, 3, 2, 1, 0][completions],
  ...
  dilatedTimeFromSingularities: {
    ...
    effect: () => 1 + Math.clampMax(Currency.singularities.value.log10() / 100, 0.35),
  ...
  darkFromDM4: {
    ...
    effect: () => DarkMatterDimension(4).amount.pow(0.03).max(1),
    effectFormat: (x) => formatX(x, 2, 2),
    upgradeDirection: LAITELA_UPGRADE_DIRECTION.SELF_BOOST,
  },
  ...
  darkFromGamespeed: {
    ...
    effect: () => Math.clampMin(getGameSpeedupFactor().div(1e120).log10() / 40, 1),
    effectFormat: (x) => formatX(x, 2, 2),
    upgradeDirection: LAITELA_UPGRADE_DIRECTION.BOOSTS_LAITELA,
  },
  glyphLevelFromSingularities: {
    ...
    effect: () => 1 + Math.clampMin((Currency.singularities.value.log10() - 20) / 30, 0),
  ...
  darkFromDilatedTime: {
    ...
    effect: () => Decimal.pow(1.6, Currency.dilatedTime.value.plus(1).log10() / 1000),
    effectFormat: (x) => formatX(x, 2, 2),
    upgradeDirection: LAITELA_UPGRADE_DIRECTION.BOOSTS_LAITELA,
  },
  infinitiedPow: {
    ...
    effect: () => 1 + Currency.singularities.value.add(1).log10() / 300,
    effectFormat: (x) => formatPow(x, 2, 3),
    upgradeDirection: LAITELA_UPGRADE_DIRECTION.BOOSTS_MAIN,
  },
  tesseractMultFromSingularities: {
    ...
    effect: () => 1 + Currency.singularities.value.log10() / 80,
    effectFormat: (x) => formatX(Math.clampMin(x, 1), 2, 2),
    upgradeDirection: LAITELA_UPGRADE_DIRECTION.BOOSTS_MAIN,
  },
};
