...
const specialInfinityGlyphDisabledEffectText = () =>
  PelleRifts.chaos.milestones[1].canBeApplied ? "The Pelle-Specific effect from Infinity Glyphs is also disabled." : "";
...
export const eternityChallenges = [
  ...
  },
  {
    ...
    formatRestriction: (restriction) =>
      restriction === 0 ? "without any Infinities" : `in ${quantifyInt("Infinity", restriction)} or less`,
  ...
  },
  {
    ...
    description: () => {
      ...
      return (
        "you cannot gain Antimatter Galaxies normally. The cost of upgrading your max Replicanti" +
