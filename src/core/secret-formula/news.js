...
export const news = [
  ...
  {
    id: "a96",
    text: `It has been scientifically proven ages ago, that cats made of matter are assholes. We have good news,
  ...
  },
  {
    ...
    get unlocked() {
      return Currency.antimatter.exponent === 15;
    },
  },
  {
    id: "l2",
    ...
    get unlocked() {
      return player.galaxies === 2 || Currency.infinities.gt(0);
    },
  },
  {
    id: "l3",
    ...
    get unlocked() {
      return AntimatterDimension(3).totalAmount.gt(0) || DimBoost.totalBoosts > 0;
    },
  },
  {
    id: "l4",
    ...
    get unlocked() {
      return AntimatterDimension(8).totalAmount.eq(190) || Currency.infinities.gt(0);
    },
  },
  {
    id: "l5",
    ...
    get unlocked() {
      return AntimatterDimension(4).totalAmount.gt(0) && AntimatterDimension(5).totalAmount.eq(0);
    },
  },
  {
    id: "l6",
    text: `Antimatter people seem to be even more afraid of 13 then we are. They destroyed
  ...
  },
  {
    ...
    get unlocked() {
      return PlayerProgress.replicantiUnlocked() && player.replicanti.chance === 0.01;
    },
  },
  {
    id: "l28",
    ...
    get unlocked() {
      return player.replicanti.chance === 1 && player.replicanti.interval === 1;
    },
  },
  {
    id: "l29",
    ...
    get unlocked() {
      return Currency.antimatter.exponent >= 100000;
    },
  },
  {
    id: "l30",
  ...
  },
  {
    ...
    get text() {
      ...
      return (
        `Pokemon ${game1Name} and ${game2Name} were just released! This new generation brings the total number ` +
  ...
  },
  {
    ...
    get text() {
      ...
      if (InfinityChallenge(4).isRunning)
        protestText = `Let's take it to this guy, who's part of the side that believes it's Infinity Challenge 4. What do you have
        ...
        protestText = `So up next let's talk to this guy is holding a sign that says "IC5 Unfair". What is the point your group
        ...
        protestText = `Finally, let's chat with this woman who doesn't seem to be in either side. What's your opinion on the
