export const atomMilestones = {
  ...
  am5: {
    ...
    while Doomed, and unlock more Automator commands. Glyph rarity is always at least 100%.`,
  },
  am6: {
    time: TimeSpan.fromHours(6).totalMilliseconds,
    ...
    Eternity upgrades bought, and max the perk shop after Ra's perk shop expansion upgrade. Glyphs
    always have all effects.`,
  },
  am7: {
    time: TimeSpan.fromHours(4).totalMilliseconds,
