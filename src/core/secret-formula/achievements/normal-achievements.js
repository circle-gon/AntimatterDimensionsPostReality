...
export const normalAchievements = [
  ...
  },
  {
    ...
    checkRequirement: () =>
      Currency.antimatter.exponent >= 63 && Currency.antimatter.productionPerSecond.gt(Currency.antimatter.value),
    checkEvent: GAME_EVENT.GAME_TICK_AFTER,
  },
  {
    id: 43,
  ...
  },
  {
    ...
    effect: () => Decimal.div(6, Time.thisInfinity.totalMinutes.add(3)).max(1),
  ...
  },
  {
    ...
    effect: () => (Player.isInAnyChallenge ? Decimal.div(4, Time.thisInfinity.totalMinutes.add(1)).max(1) : DC.D1),
  ...
  },
  {
    ...
    get description() {
      return `Play for ${formatInt(8)} days${atomTimeText()}.`;
    },
  ...
  },
  {
    ...
    effect: () => Decimal.sub(5, Time.thisInfinity.totalSeconds).mul(60).max(1),
  ...
  },
  {
    ...
    effect: () => Decimal.sub(1, Time.thisInfinity.totalMinutes).mul(100).max(1),
  ...
  },
  {
    ...
    checkRequirement: () => {
      if (player.records.recentInfinities.some((i) => i[0].eq(Decimal.MAX_LIMIT))) return false;
  ...
  },
  {
    ...
    checkRequirement: () =>
      Currency.infinityPoints.exponent >= 90 && player.requirementChecks.eternity.noAD1 && Currency.infinities.eq(0),
    checkEvent: GAME_EVENT.GAME_TICK_AFTER,
    ...
    effect() {
      ...
      return DC.D2.pow(thisInfinity.pow(0.11).min(500).mul(thisInfinity.ln()));
    },
    cap: () => Effarig.eternityCap,
    formatEffect: (value) => `${formatX(value, 2, 2)}`,
  },
  ...
  },
  {
    ...
    checkRequirement: () =>
      Currency.antimatter.exponent >= 260000 && Time.thisEternity.totalMinutes.lte(1) && player.dilation.active,
    checkEvent: GAME_EVENT.GAME_TICK_AFTER,
    get reward() {
  ...
  },
  {
    ...
    checkRequirement: () =>
      player.timestudy.studies.length === 0 && player.dilation.active && Currency.infinityPoints.exponent >= 26000,
    checkEvent: GAME_EVENT.GAME_TICK_AFTER,
  ...
  },
  {
    ...
    get description() {
      return `Play for ${formatFloat(13.7, 1)} billion years${atomTimeText()}.`;
    },
  ...
  },
  {
    ...
    checkRequirement: () =>
      EternityChallenges.all.map((ec) => ec.completions).min() >= 5 && Time.thisReality.totalSeconds.lte(1),
    checkEvent: GAME_EVENT.GAME_TICK_AFTER,
  },
  {
    id: 164,
