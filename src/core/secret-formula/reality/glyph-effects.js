...
export const glyphEffects = {
  ...
  timeEP: {
    ...
    totalDesc: () =>
      GlyphAlteration.isAdded("time") ? "Eternity Point gain ×{value} and ^{value2}" : "Eternity Point gain ×{value}",
    genericDesc: () =>
      GlyphAlteration.isAdded("time") ? "Eternity Point gain multiplier and power" : "Eternity Point gain multiplier",
  ...
  dilationTTgen: {
    ...
    genericDesc: () =>
      GlyphAlteration.isAdded("dilation") ? "Time Theorem generation and multiplier" : "Time Theorem generation",
  ...
  infinitypow: {
    ...
    effect: (level, strength) =>
      1.007 + (Math.pow(level, 0.21) * Math.pow(strength, 0.4)) / 75 + GlyphAlteration.sacrificeBoost("infinity") / 50,
    formatEffect: (x) => format(x, 3, 3),
    formatSingleEffect: (x) => format(x - 1, 3, 3),
    combine: GlyphCombiner.addExponents,
  ...
  infinityinfmult: {
    ...
    effect: (level, strength) =>
      GlyphAlteration.isEmpowered("infinity") ? DC.D1_02.pow(level) : Decimal.pow(level * strength, 1.5).times(2),
    formatEffect: (x) => format(x, 2, 1),
    combine: GlyphCombiner.multiplyDecimal,
  ...
  powerpow: {
    ...
    shortDesc: () =>
      GlyphAlteration.isAdded("power") ? "AD power +{value} and AG cost ×{value2}" : "AD power +{value}",
  ...
  effarigrm: {
    ...
    shortDesc: "RM ×{value}",
    effect: (level, strength) =>
      GlyphAlteration.isEmpowered("effarig") ? Decimal.pow(level, 1.5) : Decimal.pow(level, 0.6).mul(strength),
    formatEffect: (x) => format(x, 2, 2),
    combine: GlyphCombiner.multiplyDecimal,
  ...
  effarigachievement: {
    ...
    effect: (level, strength) =>
      1 + (Math.pow(level, 0.4) * Math.pow(strength, 0.6)) / 60 + GlyphAlteration.sacrificeBoost("effarig") / 10,
    formatEffect: (x) => format(x, 3, 3),
    formatSingleEffect: (x) => format(x - 1, 3, 3),
    combine: GlyphCombiner.addExponents,
