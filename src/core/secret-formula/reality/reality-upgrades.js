...
export const realityUpgrades = [
  ...
  },
  {
    ...
    checkRequirement: () =>
      ...
      Glyphs.activeWithoutCompanion.length === 1 &&
      Glyphs.activeWithoutCompanion[0].level >= 3,
  ...
  },
  {
    ...
    checkRequirement: () =>
      Currency.eternityPoints.exponent >= 70 && (AtomMilestone.am2.isReached || EternityChallenge(1).completions === 0),
    checkEvent: GAME_EVENT.ETERNITY_RESET_AFTER,
  ...
  },
  {
    ...
    hasFailed: () => !Array.range(5, 4).every((i) => TimeDimension(i).totalAmount.equals(0)),
    checkRequirement: () =>
      Currency.eternityPoints.exponent >= 4000 &&
      Array.range(5, 4).every((i) => TimeDimension(i).totalAmount.equals(0)),
    checkEvent: GAME_EVENT.ETERNITY_RESET_AFTER,
    canLock: true,
  ...
  },
  {
    ...
    checkRequirement: () =>
      Glyphs.activeWithoutCompanion.countWhere((g) => countValuesFromBitmask(g.effects) >= 2) === 4,
    checkEvent: GAME_EVENT.REALITY_RESET_BEFORE,
  ...
  },
  {
    ...
    checkRequirement: () =>
      MachineHandler.gainedRealityMachines.gte(5000) && Glyphs.activeWithoutCompanion.length === 0,
    canLock: true,
