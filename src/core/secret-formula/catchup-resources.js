...
export const catchupResources = [
  ...
  },
  {
    ...
    description: () => `Reality is the third reset layer. Reaching ${format(DC.E4000)} Eternity Points
  ...
  },
  {
    ...
    id: 47,
    openH2pEntry: "Atom",
    requiredStage: PROGRESS_STAGE.ATOM,
    description:
      "Atom (and the prestige layer, Collapse) is the fourth and final prestige layer. Beating a Doomed Reality unlocks the ability to Collapse.",
  },
  {
    name: "Atom Milestones",
    id: 48,
    requiredStage: PROGRESS_STAGE.ATOM,
    description: "Atom Milestones are obtained through faster Collapses and give QoL.",
  },
  {
    name: "Atoms",
    id: 49,
    requiredStage: PROGRESS_STAGE.ATOM,
    description:
      "Atoms are the primary resource obtained through Collapses, and can be used to buy Atom Upgrades. There is currently no way to increase Atom gain.",
  },
  {
    name: "Atom Upgrades",
    id: 50,
    requiredStage: PROGRESS_STAGE.ATOM,
    description: "Atom Upgrades are similar to Reality Upgrades. They are bought using Atoms.",
  },
];
