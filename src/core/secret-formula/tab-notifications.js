...
export const tabNotifications = {
  ...
  IDUnlock: {
    ...
    condition: () =>
      !PlayerProgress.realityUnlocked() && !PlayerProgress.eternityUnlocked() && !InfinityDimension(2).isUnlocked,
  },
  ICUnlock: {
    id: 3,
    tabsToHighLight: [
  ...
  replicanti: {
    ...
    condition: () =>
      !PlayerProgress.realityUnlocked() && !PlayerProgress.eternityUnlocked() && Currency.infinityPoints.gte(DC.E140),
