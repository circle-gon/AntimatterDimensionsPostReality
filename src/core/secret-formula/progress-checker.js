export const progressStages = [
   ...
   */
  {
    ...
    subProgressValue: (save) =>
      0.33 * save.galaxies + 0.02 * save.dimensionBoosts + new Decimal(save.antimatter).log10() / 16000,
  },
  {
  ...
  },
  {
    ...
    subProgressValue: (save) =>
      0.008 * Object.values(save.eternityChalls).reduce((sum, c) => sum + c, 0) +
  ...
  },
  {
    ...
    suggestedResource: () =>
      new Decimal(player.eternityPoints).log10() > 4000
  ...
  },
  {
    ...
    subProgressValue: (save) => new Decimal(save.celestials.effarig.relicShards).add(1).log10() / 14,
  },
  {
  ...
  },
  {
    ...
    subProgressValue: (save) =>
      0.0277 * Object.values(save.celestials.v.runUnlocks).reduce((total, ach) => total + ach, 0),
  },
  {
  ...
  },
  {
    ...
    subProgressValue: (save) => new Decimal(save.reality.iMCap).add(1).log10() / 9,
  },
  {
  ...
  },
  {
    ...
    subProgressValue: (save) => save.atom.atoms.div(100).min(1).toNumber(),
  },
];
