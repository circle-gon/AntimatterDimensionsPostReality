...
window.GAME_EVENT = {
  ...
  COLLAPSE_RESET_BEFORE: "COLLAPSE_RESET_BEFORE",
  COLLAPSE_RESET_AFTER: "COLLAPSE_RESET_AFTER",
  ATOMIC_PARTICLE_CONVERSION: "ATOMIC_PARTICLE_CONVERSION",
