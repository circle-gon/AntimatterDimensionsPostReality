...
Currency.antimatter = new (class extends DecimalCurrency {
  ...
  set value(value) {
    ...
    player.records.thisCollapse.maxAM = player.records.thisCollapse.maxAM.max(value);
...
Currency.infinityPoints = new (class extends DecimalCurrency {
  ...
  set value(value) {
    ...
    player.records.thisCollapse.maxIP = player.records.thisCollapse.maxIP.max(value);
...
Currency.realityMachines = new (class extends DecimalCurrency {
  ...
  set value(value) {
    ...
    player.records.thisCollapse.maxRM = player.records.thisCollapse.maxRM.max(newValue);
...
Currency.imaginaryMachines = new (class extends DecimalCurrency {
  ...
  set value(value) {
    ...
    player.records.thisCollapse.maxIM = player.records.thisCollapse.maxIM.max(newValue);
  }
})();
...
Currency.collapses = new (class extends NumberCurrency {
  get value() {
